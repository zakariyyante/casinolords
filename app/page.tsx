...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: primaryGametype?.pageTitle || "BritWager - UK's Premier Betting Affiliate Platform",
    description: primaryGametype?.headParagraph || "Discover the best UK betting brands with exclusive bonuses and offers",
  };
}
...
export default async function HomePage() {
  ...
  return (
    <>
      <Hero
        headText={primaryGametype.headText}
        headParagraph={primaryGametype.headParagraph}
        isMobile={isMobile}
      />
