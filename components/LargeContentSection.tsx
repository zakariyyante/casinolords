    ...
    <section className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold text-cta mb-8 text-center">
          Your Trusted Guide to UK Betting
        </h2>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text/90">
          <p className="text-lg leading-relaxed">
            ...
            best UK-licensed betting operators. As an independent affiliate
            platform, we provide comprehensive comparisons of top betting brands,
          ...
          <div className="bg-panel border border-cta/30 rounded-lg p-6 my-8">
            ...
            <ul className="space-y-3 list-disc list-inside">
              <li>
                <strong>UK Gambling Commission Licensed Operators Only:</strong>{" "}
                Every betting brand featured on our platform is fully licensed
              ...
              <li>
                ...
                honest information about each operator to help you find the best
                match for your betting preferences.
              </li>
            </ul>
          </div>
          ...
          <p className="leading-relaxed">
            At BritWager, we take responsible gambling seriously. All operators
            featured on our site are required to provide tools and resources for
            responsible gambling, including deposit limits, self-exclusion
            options, and access to support services. If you or someone you know
            is struggling with gambling, please seek help from organizations like
          ...
          <p className="leading-relaxed">
            Our mission is to simplify your search for the perfect betting
            operator. We carefully review and compare UK-licensed betting brands,
          ...
          <div className="bg-cta/10 border border-cta/30 rounded-lg p-6 my-8">
            ...
            <p className="text-sm leading-relaxed">
              ...
              provide. All betting operators are licensed by the UK Gambling
              Commission. Please gamble responsibly and only bet what you can
              afford to lose.
            </p>
          </div>
        </div>
